...
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.1,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.2,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.3,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.4,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.5,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.6,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.7,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.8,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s1 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.9,nw_dst=224.0.0.0/24,actions=drop')


#Drop IGMP sem necessidade s2
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.1,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.2,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.3,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.4,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.5,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.6,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.7,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.8,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s2 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.9,nw_dst=224.0.0.0/24,actions=drop')

#Drop IGMP sem necessidade s3
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.1,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.2,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.3,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.4,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.5,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.6,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.7,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.8,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s3 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.9,nw_dst=224.0.0.0/24,actions=output:controller')

#Drop IGMP sem necessidade s4
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.1,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.2,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.3,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.4,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.5,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.6,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.7,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.8,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s4 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.9,nw_dst=224.0.0.0/24,actions=drop')

#Drop IGMP sem necessidade s5
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.1,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.2,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.3,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.4,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.5,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.6,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.7,nw_dst=224.0.0.0/24,actions=output:controller')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.8,nw_dst=224.0.0.0/24,actions=drop')
os.system('ovs-ofctl add-flow s5 priority=40000,dl_type=0x0800,nw_proto=2,nw_src=10.0.0.9,nw_dst=224.0.0.0/24,actions=drop')
